...
export function FloatingChat() {
  ...
  const handlePrompt = (prompt: string) => {
    ...
    if (prompt.toLowerCase().includes("quote")) {
      response = "Absolutely. I can help you request a quote. Tell me your property type, size, cleaning type, and frequency.";
      ...
      response = "We offer residential, deep, office, commercial, move-in / move-out, and event cleaning. We can tailor a package to your space.";
    }
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {open ? (
        ...
        <button type="button" onClick={() => setOpen(true)} className="flex items-center gap-3 rounded-full bg-violet-700 px-4 py-3 text-sm font-semibold text-white shadow-[0_18px_40px_-18px_rgba(95,63,141,0.8)] transition hover:bg-violet-800">
